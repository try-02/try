...
class AddPrinterViewModel(
    ...
    private companion object {
        val log = Logger.withTag("AddPrinterVM")
    }
    ...
    fun startBluetoothScan() {
        ...
        viewModelScope.launch {
            ...
            _scanProgress.update { 0f }
            foundDevices.clear()
            _bluetoothDevices.update { emptyList() }
            ...
            scanCallback = object : ScanCallback() {
                override fun onScanResult(callbackType: Int, result: ScanResult) {
                    ...
                    if (!foundDevices.containsKey(address)) {
                        ...
                        _bluetoothDevices.update { foundDevices.values.toList() }
                    }
                }
            ...
            while (_isScanning.value) {
                ...
                _scanProgress.update { (elapsed.toFloat() / SCAN_DURATION_MS).coerceIn(0f, 1f) }
    ...
    fun testBluetoothConnection(device: BluetoothDeviceUi) {
        viewModelScope.launch {
            ...
            if (result != null) {
                ...
                _testResult.emit(PrinterTestResult.Failed(getString(R.string.err_printer_bt_connect)))
            }
        }
    }
    ...
    fun testWifiConnection(name: String, ipAddress: String, port: Int) {
        viewModelScope.launch {
            ...
            if (result != null) {
                ...
                _testResult.emit(PrinterTestResult.Failed(getString(R.string.err_printer_wifi_connect)))
            }
        }
    }
