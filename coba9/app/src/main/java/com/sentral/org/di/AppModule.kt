...
val appModule = module {
    ...
    single<com.sentral.org.data.concurrency.PosExecutionLock> { com.sentral.org.data.concurrency.PosExecutionLockImpl() }
    single {
        createPosDatabase(
    ...
    // Backup & Restore Core
    single { com.sentral.org.backup.db.DatabaseSnapshotter(get()) }
    single { com.sentral.org.backup.db.DatabaseValidator() }
    single { com.sentral.org.backup.db.DatabaseFileSwap(androidContext(), get()) }
    single { com.sentral.org.backup.crypto.BackupCryptoEngine() }
    single {
