...
class VoidServiceIntegrationTest {
    ...
    @Test
    fun voidCashMengembalikanStokMengurangiKasDanMenandaiTransaksi() =
        runTest {
            ...
            val mutasi =
                db
                    .pergerakanPersediaanDao()
                    .getByProduk(produkId)
    ...
    @Test
    fun voidQrisMengembalikanStokTanpaPergerakanKasFisik() =
        runTest {
            val sesi = seedKasirShift()
    ...
    @Test
    fun voidPadaTransaksiYangSudahDireturDitolakTanpaEfek() =
        runTest {
            val sesi = seedKasirShift()
    ...
    @Test
    fun voidGandaHanyaEfekSatuKali() =
        runTest {
            val sesi = seedKasirShift()
